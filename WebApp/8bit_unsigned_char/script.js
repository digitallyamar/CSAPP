...
function calculateValue() {
    ...
    // Display the result
    document.getElementById('result').textContent = `Resulting Value: ${value}`;
    ...
    document.getElementById('calculation').innerHTML = `Calculation: ${calculationString}`;
}

// Add event listeners to inputs for validation
document.getElementById('bit7').addEventListener('input', validateInput);
document.getElementById('bit7').addEventListener('input', calculateValue);
document.getElementById('bit6').addEventListener('input', validateInput);
document.getElementById('bit6').addEventListener('input', calculateValue);
document.getElementById('bit5').addEventListener('input', validateInput);
document.getElementById('bit5').addEventListener('input', calculateValue);
document.getElementById('bit4').addEventListener('input', validateInput);
document.getElementById('bit4').addEventListener('input', calculateValue);
document.getElementById('bit3').addEventListener('input', validateInput);
document.getElementById('bit3').addEventListener('input', calculateValue);
document.getElementById('bit2').addEventListener('input', validateInput);
document.getElementById('bit2').addEventListener('input', calculateValue);
document.getElementById('bit1').addEventListener('input', validateInput);
document.getElementById('bit1').addEventListener('input', calculateValue);
document.getElementById('bit0').addEventListener('input', validateInput);
document.getElementById('bit0').addEventListener('input', calculateValue);
